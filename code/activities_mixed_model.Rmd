...
### Distribution of response cariable (Critical Power)
...
Critical power is normally distributed, but it's good practice to standardise the explanatory variables so that they have a mean of zero ("centering") and a standard deviation of one ("scaling"). This ensures that the estimated coefficients are all on the same scale, making it easier to compare effect sizes.
